...
save_model = load_model('modelsaved_mnist.h5')

img_path = '/Users/tirth/Documents/Mnist/Test /2.2.png'
'''
...
save_model.compile(optimizer='adam', loss='categorical_crossentropy',
              metrics=['accuracy'])
#1
...
test_image = image.img_to_array(test_image).reshape((28,28,1))
