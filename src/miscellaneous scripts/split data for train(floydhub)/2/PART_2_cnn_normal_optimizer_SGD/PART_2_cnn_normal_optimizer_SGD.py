...
def cnn_model(X_train, y_train, nb_filters, channels, nb_gpus, nb_classes, kernel_size, batch_size, nb_epoch):
    ...
    #Load weights
    model.load_weights("/floyd/input/output1/saved_model/PART_1_cnn_normal_optimizer_SGD_recall_0.6182.h5")
...
if __name__ == '__main__':
    ...
    save_model(model = model, score = recall, model_name = "PART_2_cnn_normal_optimizer_SGD")
    print("Completed")
