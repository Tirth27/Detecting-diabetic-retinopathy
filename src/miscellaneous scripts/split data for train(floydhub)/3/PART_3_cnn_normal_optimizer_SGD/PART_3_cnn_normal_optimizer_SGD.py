...
def cnn_model(X_train, y_train, nb_filters, channels, nb_gpus, nb_classes, kernel_size, batch_size, nb_epoch):
    ...
    #Load weights
    model.load_weights("/floyd/input/output2/saved_model/PART_2_cnn_normal_optimizer_SGD_recall_0.6274.h5")
...
if __name__ == '__main__':
    ...
    X = np.load("/floyd/input/data/3_uncomp_save.npy")
    y = np.array(labels['level'][53200:79800])
    ...
    save_model(model = model, score = recall, model_name = "PART_3_cnn_normal_optimizer_SGD")
    print("Completed")
