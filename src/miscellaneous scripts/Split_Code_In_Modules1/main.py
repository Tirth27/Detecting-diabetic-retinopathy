...
@author: tirth
"""
import Model_Ben_Parth2_loss_change as modl
...
if __name__ == '__main__':
    ...
    train_data_dir = "F:\\Project\\Project(Main)\\Data\\Train\\remove_boundary_512\\"
    train_labels = "F:\\Project\\Project(Main)\\Labels\\Train CSV\\trainlabel_master_v2.csv"

    test_data_dir = "F:\\Project\\Project(Main)\\Data\\Test\\crop_test_512\\"
    test_labels = "F:\\Project\\Project(Main)\\Labels\\Test CSV\\testLabels.csv"
    vali_data_dir = "F:\\Project\\Project(Main)\\Data\\Test\\remove_boundary_test_512\\"

    #Saved Model Name
    model_name = 'Model_Ben_Parth2_loss_change'
    ...
    model, validation_generator, train_generator = \
                    ...
                    pooling_ratio = pooling_ratio, labels_test = labels_test, vali_data_dir = vali_data_dir)
    ...
    loss, accuracy = model.evaluate_generator(validation_generator, steps = STEP_SIZE_VALID, verbose = 1)
