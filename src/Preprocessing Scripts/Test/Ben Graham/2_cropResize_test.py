...
if __name__ == "__main__":
    #Resize to 256x256
    crop_and_resize(path = "E:\\Tirth\\test\\remove_boundary__test_Original\\",
         crop_size = 750, resize_size = 256,
         new_path = "E:\\Tirth\\test\\remove_boundary_test_256\\")
    
    #Resize to 512x512
    crop_and_resize(path = "E:\\Tirth\\test\\remove_boundary__test_Original\\",
         crop_size = 750, resize_size = 512,
         new_path = "E:\\Tirth\\test\\remove_boundary_test_512\\")
